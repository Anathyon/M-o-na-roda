        ...
        <>
            ...
            >
                <div className="flex flex-col h-full">
                    <div className="flex items-center justify-between px-6 py-4 border-b border-white/20" style={{padding:"2%"}}>
                    ...
                    <nav className="flex flex-col gap-2 px-6 py-6" style={{padding:"5%"}}>
                        <a href="#home" className="text-white font-semibold text-lg py-2 rounded-lg hover:bg-white/10 transition" onClick={() => setSidebarOpen(false)}>
                            Home
                        </a>
                        <a href="#servicos" className="text-white font-semibold text-lg py-2 rounded-lg hover:bg-white/10 transition" onClick={() => setSidebarOpen(false)}>
                            Serviços
                        </a>
                        <a href="#como-funciona" className="text-white font-semibold text-lg py-2 rounded-lg hover:bg-white/10 transition" onClick={() => setSidebarOpen(false)}>
                            Como Funciona
                        </a>
                    </nav>
                    <div className="flex flex-col gap-3 px-6 mt-auto pb-8">
                        <a
                            href="https://play.google.com/store/apps/details?id=digital.inovasoft.maonarodacliente&hl=pt_BR"
                            className="flex items-center gap-2 rounded-full border-2 border-white text-white font-semibold transition-all text-base bg-transparent hover:bg-white/10 px-4 py-3"
